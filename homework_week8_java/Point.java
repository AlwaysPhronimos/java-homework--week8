...
public class Point {
    ...
    public Point() { //constructor without parameters
        this(0, 0); // calls the parameterized constructor with default value
    }
    ...
    public double distance(int x, int y) { //Calculate distance to a specific point (x, y)
        int xDiff = x - this.x;
        int yDiff = y - this.y;
        return Math.sqrt(xDiff * xDiff + yDiff * yDiff);
    }

    public double distance(Point another) { // Calculate distance to another point (another)
